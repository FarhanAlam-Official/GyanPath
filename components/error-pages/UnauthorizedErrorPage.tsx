...
export default function UnauthorizedErrorPage(props: UnauthorizedErrorPageProps = {}) {
  const {
    viewerRole = 'guest',
    userName = 'User',
  ...
  const user = viewerRole !== 'guest' ? { role: viewerRole, first_name: userName } : null
  ...
  return (
    <div className="relative flex min-h-[100svh] flex-col items-center justify-center overflow-hidden bg-background px-6 py-16 animate-in fade-in duration-500">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center gap-8 text-center animate-in slide-in-from-bottom-4 duration-700">
        ...
        {/* User Info Card */}
        <div className="w-full max-w-xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
        ...
        {/* Action Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-xl animate-in fade-in slide-in-from-bottom-2 duration-500 delay-500">
          <Button
            asChild
        ...
        {/* Additional Help */}
        <div className="w-full max-w-3xl animate-in fade-in slide-in-from-bottom-4 duration-700 delay-700">
