...
const toastStyles = {
  success: {
    ...
    className:
      "bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 border-green-100 dark:border-green-800 dark:text-white",
  ...
  error: {
    ...
    className:
      "bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900 dark:to-rose-900 border-red-100 dark:border-red-800 dark:text-white",
  ...
  warning: {
    ...
    className:
      "bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900 dark:to-amber-900 border-yellow-100 dark:border-yellow-800 dark:text-white",
  ...
  info: {
    ...
    className:
      "bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900 border-blue-100 dark:border-blue-800 dark:text-white",
  ...
  return (
    <div
      className={cn(
        ...
        "border border-opacity-50 backdrop-blur-sm dark:backdrop-blur-none",
    ...
    >
      ...
      <div className="flex-shrink-0 animate-in zoom-in-50 duration-300">{style.icon}</div>

      {/* Content with animated entrance */}
      <div className="flex-1 min-w-0 animate-in slide-in-from-right-1 duration-300">
        <h3 className="font-semibold leading-5 tracking-tight mb-1 text-slate-900 dark:text-white">
          {title}
        </h3>
        {description && (
          <p className="text-sm opacity-90 leading-relaxed text-slate-700 dark:text-slate-200">
            {description}
          </p>
        )}
      </div>
      ...
      <div
        className={cn("absolute bottom-0 left-0 h-1", style.progressBarClass)}
        style={{
          width: "100%",
